...
# 数据切片
try:
    sub = data_df.loc['2025-01-23 18:53:01':'2025-02-02 17:53:01']
    if sub.empty:
        raise ValueError("切片范围内没有数据，请检查时间范围！")
except KeyError as e:
    print("时间切片失败：", e)
...
# 划分训练集和测试集
train = sub.loc['2025-01-23 18:53:01':'2025-01-29 15:53:01']['co2_Output']
test = sub.loc['2025-01-29 16:53:01':'2025-02-02 17:53:01']['co2_Output']
